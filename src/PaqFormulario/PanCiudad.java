 ...
 * @author Danny Veron
 */
public class PanCiudad extends javax.swing.JPanel {
    ...
    private void txtCodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCodActionPerformed
        String sql1 = "SELECT * FROM ciudad WHERE  ciu_cod=" + txtCod.getText();
                ...
                if (botonmodificar == true) {
                    try {
                        String sql = "Select * FROM ciudad "
                                + "WHERE ciu_cod=" + this.txtCod.getText();
                        //System.out.println(sql);
                        rs = con.Consulta(sql);
                        rs.next();
                        this.txtNom.setText(rs.getString("ciu_des"));
    ...
    private void txtNomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNomActionPerformed
        String sql = "SELECT * FROM ciudad WHERE ciu_des='" + txtNom.getText() + "'";
    ...
    private void btnGraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGraActionPerformed
        ...
        if (res == JOptionPane.OK_OPTION) {
            if (botonagregar == true) {
                String sql = "INSERT INTO ciudad (ciu_cod,ciu_des)"
            ...
            if (botonmodificar == true) {
                String update = "UPDATE ciudad SET "
                        + "ciu_des='" + this.txtNom.getText()
                        + "' WHERE ciu_cod=" + this.txtCod.getText();
            ...
            try {
                if (PanAlumno.dialogo.isVisible() == true) {
                    PanAlumno.dialogo.dispose();
                    PanAlumno.texto = txtNom.getText();
                }
            } catch (NullPointerException n) {
            }
    ...
    private void btnAgrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgrActionPerformed
        try {
            botonagregar = true;
            String sql = "Select ifnull(max(ciu_cod),0)+1 codigo From ciudad";
            //System.out.println(sql);
            rs = con.Consulta(sql);
            rs.next();
    ...
    public boolean comparar(String sql) {
        ...
        try {
            ...
            Logger.getLogger(PanCiudad.class.getName()).log(Level.SEVERE, null, ex);
        }
        return r;
    }
